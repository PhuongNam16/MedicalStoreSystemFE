    ...
    if (this.state.loginStatus === 0) {
      ...
      return (
        <div class="alert alert-warning">
          <strong>Đang đăng nhập!</strong> Vui lòng đợi...
        </div>
      );
      ...
      return (
        <div class="alert alert-danger">
          <strong>Sai thông tin đăng nhập, vui lòng thử lại...</strong>
        </div>
      );
    }
  };
    ...
    return (
      <React.Fragment>
        ...
        <div className="login-box">
          <div className="logo">
            <a href="javascript:void(0);">HỆ THỐNG QUẢN LÝ CỦA HÀNG THUỐC</a>
          </div>
          <div className="card">
            <div className="body">
