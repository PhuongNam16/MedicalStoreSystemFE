          ...
          <div className="row clearfix">
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-pink hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng yêu cầu</div>
                  <div
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-light-green hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng số thuốc</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="243"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-orange hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng công ty</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="1225"
          ...
          <div className="row clearfix">
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-pink hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng nhân viên</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="125"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-cyan hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng lợi nhuận</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="257"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-light-green hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Tổng số tiền bán hàng</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="243"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-orange hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Thuốc hết hạn trong tuần</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="1225"
          ...
          <div className="row clearfix">
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-pink hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Yêu cầu đã hoàn thành</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="125"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-cyan hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Yêu cầu đóng</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="257"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-light-green hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Số tiền bán hàng hôm nay</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="243"
            ...
            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div className="info-box bg-orange hover-expand-effect">
                ...
                <div className="content">
                  <div className="text">Lợi nhuận bán hàng hôm nay</div>
                  <div
                    className="number count-to"
                    data-from="0"
                    data-to="1225"
