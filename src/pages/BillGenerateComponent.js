...
class BillGenerateComponent extends React.Component {
  ...
  billGeneratePrint(customer_name, address, phone, medicineDetails) {
    ...
    billDetails += "Hóa đơn cho khách hàng";
    billDetails += "</td>";
    billDetails += "</tr>";
    billDetails += "<tr>";
    billDetails += "<td colspan='2'>";
    billDetails += "Tên khách hàng : " + customer_name;
    billDetails += "</td>";
    billDetails += "<td colspan='3'>";
    billDetails += "Địa chỉ : " + address;
    billDetails += "</td>";
    billDetails += "<td colspan='2'>";
    billDetails += "Điện thoại : " + phone;
    billDetails += "</td>";
    billDetails += "</tr>";
    billDetails += "<tr>";
    billDetails += "<th>";
    ...
    billDetails += "</th>";
    billDetails += "<th>";
    billDetails += "Tên thuốc : ";
    billDetails += "</th>";
    billDetails += "<th>";
    billDetails += "Số lượng :";
    billDetails += "</th>";
    billDetails += "<th>";
    billDetails += "Loại ";
    billDetails += "</th>";
                    ...
                    {this.state.medicineDetails.map((item, index) => (
                      <div className="row" key={index}>
                        <div className="col-lg-2">
                          <label htmlFor="email_address">Số SR : </label>
                          <div className="form-group">
                            <div className="form-line">
                              <input
                                type="text"
                        ...
                        <div className="col-lg-2">
                          <label htmlFor="email_address">Loại : </label>
                          <div className="form-group">
                            <div className="form-line">
                              <input
                                type="text"
                        ...
                        <div className="col-lg-2">
                          <label htmlFor="email_address">Đơn giá : </label>
                          <div className="form-group">
                            <div className="form-line">
                              <input
                                type="text"
                        ...
                        <div className="col-lg-2">
                          <label htmlFor="email_address">Số tiền: </label>
                          <div className="form-group">
                            <div className="form-line">
                              <input
                                type="text"
