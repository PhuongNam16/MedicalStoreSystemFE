        ...
        <aside id="leftsidebar" className="sidebar">
          <div className="user-info">
            ...
            <div className="info-container">
              ...
              <div className="email">phuongnamhd00@gmail.com</div>
                ...
                <ul className="dropdown-menu pull-right">
                  <li>
                    <a
                      ...
                      ref={this.divref2}
                    >
                      <i className="material-icons">input</i>Đăng xuất
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div className="legal">
            <div className="copyright">
              © 2020 - 2021 <a href="#">PhuongNam Pharmacy</a>.
            </div>
            <div className="version">
              <b>GitHub: </b>
              <a href="https://github.com/PhuongNam16">
                https://github.com/PhuongNam16
              </a>
            </div>
          </div>
        </aside>
